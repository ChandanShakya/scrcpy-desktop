...
# This is a more robust version of the above command
display=$(adb shell 'dumpsys display|grep mDisplayId=|cut -d "=" -f2|sort -n|uniq|grep -v "^0$"|grep -v "^ "|grep -v "^:"|head -n1')
